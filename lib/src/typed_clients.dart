...
class PublicApiClient {
  ...
  Future<ApiResponse<HealthStatus>> health() =>
      _client.request<HealthStatus>('GET', '/api/health',
          authenticated: false, decoder: HealthStatus.fromJson);
  Future<ApiResponse<HealthStatus>> readiness() =>
      _client.request<HealthStatus>('GET', '/api/health/ready',
          authenticated: false, decoder: HealthStatus.fromJson);

  Future<ApiResponse<List<CatalogProduct>>> listProducts(
          {CatalogQuery query = const CatalogQuery()}) =>
      _client.request<List<CatalogProduct>>('GET', '/api/v1/products',
          queryModel: query,
          authenticated: false,
          decoder: (data) => _decodeList(data, CatalogProduct.fromJson));
  Future<ApiResponse<CatalogProduct>> getProduct(String idOrSlug,
          {AppLocale? locale}) =>
      _client.request<CatalogProduct>('GET', '/api/v1/products/$idOrSlug',
  ...
  Future<ApiResponse<List<CatalogTaxonomy>>> listCategories(
          {AppLocale? locale}) =>
      _client.request<List<CatalogTaxonomy>>('GET', '/api/v1/categories',
          queryModel: LocaleQuery(locale: locale),
          authenticated: false,
  ...
  Future<ApiResponse<List<CatalogTaxonomy>>> listBrands({AppLocale? locale}) =>
      _client.request<List<CatalogTaxonomy>>('GET', '/api/v1/brands',
          queryModel: LocaleQuery(locale: locale),
          authenticated: false,
          decoder: (data) => _decodeList(data, CatalogTaxonomy.fromJson));
  Future<ApiResponse<List<JsonMap>>> hero({AppLocale? locale}) =>
      _client.request<List<JsonMap>>('GET', '/api/v1/hero',
          queryModel: LocaleQuery(locale: locale),
          authenticated: false,
          decoder: (data) => _decodeMaps(data));
  Future<ApiResponse<JsonMap>> commerceCountry() =>
      _client.request<JsonMap>('GET', '/api/v1/commerce/country',
          authenticated: false, decoder: _decodeMap);
  Future<ApiResponse<List<JsonMap>>> shippingCountries() =>
      _client.request<List<JsonMap>>('GET', '/api/v1/shipping/countries',
          authenticated: false, decoder: (data) => _decodeMaps(data));
  Future<ApiResponse<List<String>>> shippingGovernorates(
          {required String country}) =>
      _client.request<List<String>>('GET', '/api/v1/shipping/governorates',
          query: {'country': country},
          authenticated: false,
          decoder: (data) => _decodeStrings(data));
  Future<ApiResponse<List<JsonMap>>> shippingRegions(
          {required String country}) =>
      _client.request<List<JsonMap>>('GET', '/api/v1/shipping/regions',
          query: {'country': country},
          authenticated: false,
          decoder: (data) => _decodeMaps(data));
...
class AuthApiClient {
  ...
  Future<ApiResponse<AuthSession>> signIn(SignInRequest request) =>
      _client.request<AuthSession>('POST', '/api/auth/sign-in/email',
          body: request, decoder: AuthSession.fromJson);
  Future<ApiResponse<AuthSession>> signUp(SignUpRequest request) =>
      _client.request<AuthSession>('POST', '/api/auth/sign-up/email',
          body: request, decoder: AuthSession.fromJson);
  Future<ApiResponse<AuthSession>> session() =>
      _client.request<AuthSession>('GET', '/api/auth/get-session',
...
class CheckoutApiClient {
  ...
  Future<ApiResponse<CheckoutQuote>> quote(CheckoutQuoteRequest request) =>
      _client.request<CheckoutQuote>('POST', '/api/v1/checkout/quote',
          body: request, decoder: CheckoutQuote.fromJson, authenticated: false);
}
...
class CartApiClient {
  ...
  Future<ApiResponse<CartModel>> add(CartItemInput request, {String? cartId}) =>
      _client.request<CartModel>('POST', '/api/v1/cart',
          ...
          headers: {if (cartId != null) 'x-cart-id': cartId},
          decoder: CartModel.fromJson);
  Future<ApiResponse<CartModel>> update(CartItemInput request,
          {String? cartId}) =>
      _client.request<CartModel>('PATCH', '/api/v1/cart',
          body: request,
          headers: {if (cartId != null) 'x-cart-id': cartId},
          decoder: CartModel.fromJson);
  Future<ApiResponse<JsonMap>> clear({String? cartId}) =>
      _client.request<JsonMap>('DELETE', '/api/v1/cart',
          headers: {if (cartId != null) 'x-cart-id': cartId},
          decoder: _decodeMap);
  Future<ApiResponse<CartModel>> merge(CartMergeRequest request) =>
      _client.request<CartModel>('POST', '/api/v1/cart/merge',
          body: request, decoder: CartModel.fromJson);
}
...
class AddressesApiClient {
  ...
  Future<ApiResponse<List<Address>>> list({String? id}) =>
      _client.request<List<Address>>('GET', '/api/v1/addresses',
  ...
  Future<ApiResponse<Address>> create(AddressCreateRequest request) =>
      _client.request<Address>('POST', '/api/v1/addresses',
          body: request, decoder: Address.fromJson);
  Future<ApiResponse<Address>> update(
          String id, AddressUpdateRequest request) =>
      _client.request<Address>('PATCH', '/api/v1/addresses/$id',
          body: request, decoder: Address.fromJson);
  Future<ApiResponse<JsonMap>> delete(String id) => _client
      .request<JsonMap>('DELETE', '/api/v1/addresses/$id', decoder: _decodeMap);
  Future<ApiResponse<Address>> setDefault(
          String id, DefaultAddressRequest request) =>
      _client.request<Address>('PATCH', '/api/v1/addresses/$id/default',
          body: request, decoder: Address.fromJson);
}
...
class OrdersApiClient {
  ...
  Future<ApiResponse<OrderModel>> create(OrderInput request,
          {String? idempotencyKey}) =>
      _client.request<OrderModel>('POST', '/api/v1/orders',
          body: request,
          idempotencyKey: idempotencyKey,
          decoder: OrderModel.fromJson);
  Future<ApiResponse<List<OrderModel>>> list(
          {PageQuery query = const PageQuery()}) =>
      _client.request<List<OrderModel>>('GET', '/api/v1/orders',
          queryModel: query,
          decoder: (data) => _decodeList(data, OrderModel.fromJson));
  Future<ApiResponse<OrderModel>> get(String id) =>
      _client.request<OrderModel>('GET', '/api/v1/orders/$id',
          decoder: OrderModel.fromJson);
}
...
class AdminApiClient {
  ...
  Future<ApiResponse<List<CatalogProduct>>> products(
      ...
      _client.request<List<CatalogProduct>>('GET', '/api/v1/admin/products',
          queryModel: query,
          decoder: (data) => _decodeList(data, CatalogProduct.fromJson));
  Future<ApiResponse<CatalogProduct>> createProduct(
          AdminProductCreateRequest request) =>
      _client.request<CatalogProduct>('POST', '/api/v1/admin/products',
          body: request, decoder: CatalogProduct.fromJson);
  Future<ApiResponse<CatalogProduct>> updateProduct(
          AdminProductUpdateRequest request) =>
      _client.request<CatalogProduct>('PATCH', '/api/v1/admin/products',
          body: request, decoder: CatalogProduct.fromJson);
  Future<ApiResponse<JsonMap>> deleteProduct(String id) =>
      _client.request<JsonMap>('DELETE', '/api/v1/admin/products',
          query: {'id': id}, decoder: _decodeMap);

  Future<ApiResponse<List<CatalogTaxonomy>>> categories(
          {AdminPageQuery query = const AdminPageQuery()}) =>
      _client.request<List<CatalogTaxonomy>>('GET', '/api/v1/admin/categories',
          queryModel: query,
          decoder: (data) => _decodeList(data, CatalogTaxonomy.fromJson));
  Future<ApiResponse<CatalogTaxonomy>> createCategory(
          TaxonomyCreateRequest request) =>
      _client.request<CatalogTaxonomy>('POST', '/api/v1/admin/categories',
          body: request, decoder: CatalogTaxonomy.fromJson);
  Future<ApiResponse<CatalogTaxonomy>> updateCategory(
          String id, TaxonomyUpdateRequest request) =>
      _client.request<CatalogTaxonomy>('PATCH', '/api/v1/admin/categories/$id',
          body: request, decoder: CatalogTaxonomy.fromJson);
  Future<ApiResponse<JsonMap>> deleteCategory(String id) =>
      _client.request<JsonMap>('DELETE', '/api/v1/admin/categories/$id',
          decoder: _decodeMap);

  Future<ApiResponse<List<CatalogTaxonomy>>> brands(
          {AdminPageQuery query = const AdminPageQuery()}) =>
      _client.request<List<CatalogTaxonomy>>('GET', '/api/v1/admin/brands',
          queryModel: query,
          decoder: (data) => _decodeList(data, CatalogTaxonomy.fromJson));
  Future<ApiResponse<CatalogTaxonomy>> createBrand(
          TaxonomyCreateRequest request) =>
      _client.request<CatalogTaxonomy>('POST', '/api/v1/admin/brands',
          body: request, decoder: CatalogTaxonomy.fromJson);
  Future<ApiResponse<CatalogTaxonomy>> updateBrand(
          String id, TaxonomyUpdateRequest request) =>
      _client.request<CatalogTaxonomy>('PATCH', '/api/v1/admin/brands/$id',
          body: request, decoder: CatalogTaxonomy.fromJson);
  Future<ApiResponse<JsonMap>> deleteBrand(String id) =>
      _client.request<JsonMap>('DELETE', '/api/v1/admin/brands/$id',
          decoder: _decodeMap);

  Future<ApiResponse<List<JsonMap>>> coupons(
          {AdminPageQuery query = const AdminPageQuery()}) =>
      _client.request<List<JsonMap>>('GET', '/api/v1/admin/coupons',
          queryModel: query, decoder: (data) => _decodeMaps(data));
  Future<ApiResponse<JsonMap>> createCoupon(CouponRequest request) =>
      _client.request<JsonMap>('POST', '/api/v1/admin/coupons',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> updateCoupon(String id, CouponRequest request) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/coupons/$id',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> deleteCoupon(String id) =>
      _client.request<JsonMap>('DELETE', '/api/v1/admin/coupons/$id',
          decoder: _decodeMap);

  Future<ApiResponse<List<JsonMap>>> wallets(
          {AdminPageQuery query = const AdminPageQuery()}) =>
      _client.request<List<JsonMap>>('GET', '/api/v1/admin/wallets',
          queryModel: query, decoder: (data) => _decodeMaps(data));
  Future<ApiResponse<JsonMap>> createWallet(WalletRequest request) =>
      _client.request<JsonMap>('POST', '/api/v1/admin/wallets',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> updateWallet(String id, WalletRequest request) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/wallets/$id',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> deleteWallet(String id) =>
      _client.request<JsonMap>('DELETE', '/api/v1/admin/wallets/$id',
          decoder: _decodeMap);

  Future<ApiResponse<List<JsonMap>>> tags(
          {AdminPageQuery query = const AdminPageQuery()}) =>
      _client.request<List<JsonMap>>('GET', '/api/v1/admin/tags',
          queryModel: query, decoder: (data) => _decodeMaps(data));
  Future<ApiResponse<JsonMap>> createTag(TagRequest request) =>
      _client.request<JsonMap>('POST', '/api/v1/admin/tags',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> updateTag(String id, TagRequest request) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/tags/$id',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> deleteTag(String id) =>
      _client.request<JsonMap>('DELETE', '/api/v1/admin/tags/$id',
          decoder: _decodeMap);

  Future<ApiResponse<JsonMap>> adjustInventory(InventoryAdjustment request) =>
      _client.request<JsonMap>('POST', '/api/v1/admin/inventory',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> transitionOrder(
          OrderTransitionRequest request) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/orders',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> transitionOrderById(
          String id, OrderTransitionRequest request) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/orders/$id',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> moderateReview(
          ReviewModerationRequest request) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/reviews',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> moderateReviewById(String id, String status) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/reviews/$id',
          body: ReviewModerationRequest(reviewId: id, status: status),
          decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> updateUser(
          String id, AdminUserUpdateRequest request) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/users/$id',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> createRole(RoleCreateRequest request) =>
      _client.request<JsonMap>('POST', '/api/v1/admin/roles',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> paymentProvider(
          PaymentProviderSettingsRequest request) =>
      _client.request<JsonMap>('PUT', '/api/v1/admin/payment-providers',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> updatePaymentProvider(
          String provider, PaymentProviderSettingsRequest request) =>
      _client.request<JsonMap>(
          'PATCH', '/api/v1/admin/payment-providers/$provider',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> testPaymentProvider(
          String provider, JsonModel request) =>
      _client.request<JsonMap>(
  ...
  Future<ApiResponse<JsonMap>> createShippingZone(
      ...
      _client.request<JsonMap>('POST', '/api/v1/admin/shipping',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> updateShippingZone(
          String id, ShippingZoneRequest request) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/shipping/$id',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> createShippingCountry(
          ShippingCountryCreateRequest request) =>
      _client.request<JsonMap>('POST', '/api/v1/admin/shipping-countries',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> createShippingGovernorate(
          ShippingGovernorateCreateRequest request) =>
      _client.request<JsonMap>('POST', '/api/v1/admin/shipping-governorates',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> createHeroSlide(
          HeroSlideCreateRequest request) =>
      _client.request<JsonMap>('POST', '/api/v1/admin/hero-slides',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> reorderHeroSlides(
          HeroSlideReorderRequest request) =>
      _client.request<JsonMap>('POST', '/api/v1/admin/hero-slides/reorder',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> updateContact(
          String id, ContactStatusUpdateRequest request) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/contact/$id',
          body: request, decoder: _decodeMap);
  Future<ApiResponse<JsonMap>> settings(JsonModel request) =>
      _client.request<JsonMap>('PATCH', '/api/v1/admin/settings',
          body: request, decoder: _decodeMap);
}
