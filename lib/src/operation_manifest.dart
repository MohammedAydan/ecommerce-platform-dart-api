...
const backendSourceCommit = 'f072474468af80191a025f74c35b4ef92746ce11';
...
const ecommercePlatformOperations = <ApiOperation>[
  ...
  ApiOperation(
    method: 'POST',
    path: '/api/v1/account/orders/{id}/returns',
    sourceFile: 'app/api/v1/account/orders/[id]/returns/route.ts',
  ),
  ApiOperation(
    method: 'GET',
    path: '/api/v1/account/orders/{id}/receipt',
