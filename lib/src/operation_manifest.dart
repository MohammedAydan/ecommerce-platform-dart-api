class ApiOperation {
  const ApiOperation(
      {required this.method, required this.path, required this.sourceFile});
  final String method;
  final String path;
  final String sourceFile;
}

const backendSourceCommit = 'ca7306ec4faae13979af256cd818723e897b02e4';
...
const ecommercePlatformOperations = <ApiOperation>[
  ...
  ApiOperation(
      ...
      sourceFile:
          'app/api/v1/admin/payment-providers/[provider]/test/route.ts'),
  ApiOperation(
      method: 'GET',
  ...
  ApiOperation(
      ...
      sourceFile:
          'app/api/v1/shipping/countries/[code]/payment-methods/route.ts'),
  ApiOperation(
      method: 'GET',
